...
Tin về dịch bệnh trên Internet rất nhiễu: tin cũ, tin thú y, tin nước ngoài, tin tuyên truyền, tin trùng lặp. Để bản đồ có ích, hệ thống áp dụng **nhiều lớp lọc** trước khi một tin được hiển thị:
...
- Mỗi cycle quét toàn bộ nguồn với 20 từ khoá dịch bệnh tiếng Việt
