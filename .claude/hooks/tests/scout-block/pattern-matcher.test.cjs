...
describe('loadPatterns', () => {
  it('loads patterns from fixture file', () => {
    const patterns = loadPatterns(path.join(FIXTURES_DIR, 'mkignore-default.txt'));
  ...
  it('loads custom patterns', () => {
    const patterns = loadPatterns(path.join(FIXTURES_DIR, 'mkignore-custom.txt'));
  ...
  it('loads negation patterns', () => {
    const patterns = loadPatterns(path.join(FIXTURES_DIR, 'mkignore-negation.txt'));
