...
python3 ~/.claude/skills/design/scripts/cip/generate.py --brand "ExampleCorp" --logo /path/to/logo.png --deliverable "business card" --industry "consulting"

# Full CIP set with logo
python3 ~/.claude/skills/design/scripts/cip/generate.py --brand "ExampleCorp" --logo /path/to/logo.png --industry "consulting" --set

# Pro model for 4K text rendering
python3 ~/.claude/skills/design/scripts/cip/generate.py --brand "ExampleCorp" --logo logo.png --deliverable "business card" --model pro
...
```bash
python3 ~/.claude/skills/design/scripts/cip/render-html.py --brand "ExampleCorp" --industry "consulting" --images /path/to/cip-output
python3 ~/.claude/skills/design/scripts/cip/render-html.py --brand "ExampleCorp" --industry "consulting" --images ./example-cip --output presentation.html
```
