...
Examples:
  ...
  python generate.py --brand "ExampleCorp" --logo /path/to/logo.png --deliverable "business card"

  # Generate CIP set with logo
  python generate.py --brand "ExampleCorp" --logo /path/to/logo.png --industry "consulting" --set
