...
Examples:
  ...
  python render-html.py --brand "ExampleCorp" --industry "consulting" --images ./example-cip

  # Specify output path
  python render-html.py --brand "ExampleCorp" --industry "consulting" --images ./cip --output presentation.html
        """
    )
