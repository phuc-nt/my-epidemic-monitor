...
config = types.GenerateContentConfig(
    ...
    safety_settings=[
        types.SafetySetting(
            ...
            threshold=types.HarmBlockThreshold.BLOMK_MEDIUM_AND_ABOVE
        ),
        types.SafetySetting(
...
- `BLOMK_NONE`: No blocking
- `BLOMK_LOW_AND_ABOVE`: Block low probability and above
- `BLOMK_MEDIUM_AND_ABOVE`: Block medium and above (default)
- `BLOMK_ONLY_HIGH`: Block only high probability
