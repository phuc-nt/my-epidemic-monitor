...
- `/mk:kanban` - View dashboard for ./plans directory
- `/mk:kanban <dir>` - View dashboard for specific directory
- `/mk:kanban --stop` - Stop running server
...
The `/mk:kanban` command will evolve into **VibeKanban-inspired** AI agent orchestration:
...
Track progress: https://github.com/my-kit/my-agent-kit/issues/189
